    ...
    return (
        <section id="contact" className="py-20 px-6 scroll-mt-24">
            <div className="max-w-md mx-auto">
                <h2 className="font-display text-4xl sm:text-5xl font-bold text-center mb-3 textonyx">
                    Get In Touch
                </h2>
                ...
                <FadeIn>
                    <form
                        ...
                        <textarea
                            ...
                            rows={4}
                            className="border border-ash rounded-md px-3 py-2 text-onyx placeholder:text-graphite/60 focus:outline-none focus:ring-2 focus:ring-onyx/40" />
                        <button disabled={status === "sending"} className="bg-onyx text-platinum rounded-md py-2 hover:bg-graphite transition-colors disabled:opacity-60">
